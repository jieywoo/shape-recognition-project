...
#define order 37
#define ordre_N order+1 // +1 car il faut prendre en compte l'ordre 0

#define Img1_DataBase "database/carre.bmp"
#define Img2_DataBase "database/carre2.bmp"
#define Img3_DataBase "database/carre21.bmp"
#define Img4_DataBase "database/IMAGE.bmp"
#define Img5_DataBase "database/lettre_i.bmp"

#define fichierImg1 "database/REF_carre.txt"
#define fichierImg2 "database/REF_A.txt"
#define fichierImg3 "database/REF_carre.txt"
#define fichierImg4 "database/REF_C.txt"
#define fichierImg5 "database/REF_I.txt"

#define Img1_test "test/carre.bmp"
#define Img2_test "test/carre2.bmp"
#define Img3_test "test/carre21.bmp"
#define Img4_test "test/IMAGE.bmp"
#define Img5_test "test/lettre_i.bmp"

#define ImgOut "img_Out/imgResult.bmp"

/**
    Cette structure servira de base pour la manipulation
    des différentes matrices utilisées
*/
...
typedef struct matrice_S
{
    ...
    int dimLigne; // Dimension Lignes
    int dimColonne; // Dimension Colonne
} MATRIX;
